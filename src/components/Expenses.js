...
const Expenses = () => {
  ...
  // Inicializa el estado con movement_type como 'E'
  const [movementData, setMovementData] = useState({ 
    description: '', 
    amount: '', 
    movement_date: '', 
    branch_id: '', 
    movement_type: 'E'  // Siempre será 'I' para gastos
  });
  ...
  const handleModalClose = () => {
    setShowModal(false);
    setEditMode(false);
    setMovementData({ description: '', amount: '', movement_date: '', branch_id: '', movement_type: 'E' }); // Resetea el formulario con movement_type 'I'
  };
  ...
  const handleEditMovement = (movement) => {
    ...
    setMovementData({ 
      ...
      movement_type: 'E'  // Asegúrate de que al editar también sea 'I'
    });
    setEditMode(true);
    handleModalShow();
  };
  ...
  const handleUpdateMovement = async () => {
    try {
      // Al actualizar, también movement_type será 'E'
      ...
      console.error('Error al actualizar la gasto:', error);
    }
  };
    ...
    <Layout title="Gastos">
      ...
      <Modal show={showModal} onHide={handleModalClose}>
        <Modal.Header closeButton>
          <Modal.Title>{editMode ? 'Editar Gasto' : 'Nuevo Gasto'}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
